...
const Studentdata = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        // 1) 付箋一覧
        const stickyRes = await fetch(
          `${URL}/api/sticky?student_id=${studentId}`
        );
        ...
        const stickyItems: HistoryItem[] = stickies.map((s) => ({
          camp_name:
            campNameMap[student?.camp_id || 0] ||
            `陣営 ${student?.camp_id || 0}`,
          ...
          <div className={styles.tdown}>
            ...
            <div className={styles.status_container}>
              ...
              <div className={styles.status_right}>
                ...
                <Progressbar
                  remaining={nextThreshold - student.sum_point}
